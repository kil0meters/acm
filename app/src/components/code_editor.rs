...
//
// TAKEN DIRECTLY FROM THE RUST-MONACO REPO DUE TO DEP CONFLICT FOR YEW
// https://github.com/siku2/rust-monaco/blob/master/src/yew/mod.rs
...
impl Component for CodeEditor {
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        html! {
            <div ref={node_ref.clone()} class={classes!("code-editor", props.classes.clone())} />
        }
    }
