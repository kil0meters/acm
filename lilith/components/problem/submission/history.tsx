    ...
    if (error) {
        return (
            <div className="flex gap-2 items-center bg-red-100 dark:bg-red-900 p-4 border-neutral-300 dark:border-red-700 border-b">
                ...
                <ShareButton className="px-4 py-2 text-sm bg-neutral-300 dark:bg-neutral-700 hover:bg-neutral-200 hover:dark:bg-neutral-600 rounded-full font-bold transition-colors" path={`/submissions/${id}`} />
